...
(function ($) {
  ...
  var $text_sm_brand_container = $('<div />', { class: 'mb-1' }).append($text_sm_brand_checkbox).append('<span>VehicleBrand</span>')
  ...
  $container.append('<h6>VehicleBrand Logo Variants</h6>')
